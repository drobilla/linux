...
static SENSOR_DEVICE_ATTR_2(temp1_min, 0644, show_temp, set_temp,
			    0, 1);
static SENSOR_DEVICE_ATTR_2(temp1_max, 0644, show_temp, set_temp,
			    0, 2);
static SENSOR_DEVICE_ATTR_2(temp1_offset, 0644, show_temp,
			    set_temp, 0, 3);
static SENSOR_DEVICE_ATTR_2(temp2_input, 0444, show_temp, NULL, 1, 0);
static SENSOR_DEVICE_ATTR_2(temp2_min, 0644, show_temp, set_temp,
			    1, 1);
static SENSOR_DEVICE_ATTR_2(temp2_max, 0644, show_temp, set_temp,
			    1, 2);
static SENSOR_DEVICE_ATTR_2(temp2_offset, 0644, show_temp,
			    set_temp, 1, 3);
static SENSOR_DEVICE_ATTR_2(temp3_input, 0444, show_temp, NULL, 2, 0);
static SENSOR_DEVICE_ATTR_2(temp3_min, 0644, show_temp, set_temp,
			    2, 1);
static SENSOR_DEVICE_ATTR_2(temp3_max, 0644, show_temp, set_temp,
			    2, 2);
static SENSOR_DEVICE_ATTR_2(temp3_offset, 0644, show_temp,
			    set_temp, 2, 3);
...
static SENSOR_DEVICE_ATTR(temp1_type, 0644, show_temp_type,
			  set_temp_type, 0);
static SENSOR_DEVICE_ATTR(temp2_type, 0644, show_temp_type,
			  set_temp_type, 1);
static SENSOR_DEVICE_ATTR(temp3_type, 0644, show_temp_type,
			  set_temp_type, 2);
...
static SENSOR_DEVICE_ATTR(in0_beep, 0644, show_beep, set_beep, 1);
...
static SENSOR_DEVICE_ATTR(temp1_beep, 0644, show_beep, set_beep, 2);
